...
import { createReview, deleteReview, getAdminReviews, uploadReviewImage } from "../controllers/reviewController.js";
...
router.post("/reviews/upload-image", protect, adminOnly, uploadReviewImage);
